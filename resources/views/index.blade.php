    ...
    <div class="container-fluid">
        <div class="row">
            <div class="pogoSlider" id="js-main-slider">
                <div class="pogoSlider-slide" style="background-image:url({{asset('assets/img/banner-img.png')}});">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-12 text_align_center padding_0">
                <div class="full">
                    <img class="img-responsive" src="{{asset('assets/img/img-2png.png')}}" alt="#" />
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row margin-top_30">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="service_blog">
                    <div class="service_icons">
                        <img width="75" height="75" src="{{asset('assets/img/icon-1.png')}}" alt="#">
                    </div>
                    <div class="full">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="service_blog">
                    <div class="service_icons">
                        <img width="75" height="75" src="{{asset('assets/img/icon-2.png')}}" alt="#">
                    </div>
                    <div class="full">
                        <h4>DIGITAL marketing</h4>
                    </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="service_blog">
                    <div class="service_icons">
                        <img width="75" height="75" src="{{asset('assets/img/icon-3.png')}}" alt="#">
                    </div>
                    <div class="full">
                        <h4>DIGITAL marketing</h4>
                    </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="service_blog">
                    <div class="service_icons">
                        <img width="75" height="75" src="{{asset('assets/img/icon-4.png')}}" alt="#">
                    </div>
                    <div class="full">
                        <h4>DIGITAL marketing</h4>
                    </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="service_blog">
                    <div class="service_icons">
                        <img width="75" height="75" src="{{asset('assets/')}}img/icon-5.png" alt="#">
                    </div>
                    <div class="full">
                        <h4>DIGITAL marketing</h4>
                    </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="service_blog">
                    <div class="service_icons">
                        <img width="75" height="75" src="{{asset('assets/')}}img/icon-6.png" alt="#">
                    </div>
                    <div class="full">
                        <h4>DIGITAL marketing</h4>
                    </div>
